#-----------this module is for checking account no and password of account FROM which we want to transfer-----------
...
from account_to_graphics import account
global e_acc
...
class account_to_account:
    def __init__(self,root):
        ...
        lbl_ref_num=Label(labelframeleft,text="Account No (from which you want to transfer): ",font=("times new roman",12,"bold"),padx=2,pady=6)
