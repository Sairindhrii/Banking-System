...
from sub_change_password_graphics import accept
import csv
global e_acc
...
class change_pass:
    def __init__(self,root):
        ...
        #---------------------------------------------------------title----------------------------------------------------------------------------------------------
        lbl_title=Label(self.root,text="Check Account Number & Old Password",font=("times new roman",12,"bold"),bg="black",fg="gold",bd=4,relief=RIDGE)
